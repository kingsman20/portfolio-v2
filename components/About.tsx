        ...
        <div className="lg:mt-12 lg:px-4 ">
          ...
          <div className="mt-6 text-gray-800 dark:text-white">
            <p className="mb-4 lg:text-2xl">
              I'm Kingsley Obot. A Software Developer and Writer. I work at{' '}
              <a
            ...
            <p className="mb-4">
              Currently developing apps on Node, Typescript, Express.js, React,
              AWS, Serverless, Auth0, Java, Spring Boot, and writing articles on
              Medium in my free time about challenges in IT.
            </p>
            <p className="mb-4">
              Welcome to my digital garden, where I would be sharing what I'm
          ...
          <div className="mt-6 flex justify-center">
            <div className="flex space-x-4 font-medium text-gray-800 dark:text-white sm:block sm:flex md:flex lg:flex">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                href="https://twitter.com/MrKingslife"
              >
                <svg
                  stroke="currentColor"
                  fill="currentColor"
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                href="https://www.linkedin.com/in/kingsley-obot-630b42127/"
              >
                <svg
                  stroke="currentColor"
                  fill="currentColor"
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                href="https://github.com/kingsman20"
              >
                <svg
                  stroke="currentColor"
                  fill="currentColor"
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                href="https://medium.com/@kingslifeudo"
              >
                <svg
                  stroke="currentColor"
                  fill="currentColor"
